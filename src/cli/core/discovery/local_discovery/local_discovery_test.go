...
func TestLocalDiscovery_Discover(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				paths: []string{
					filepath.Join("testdata", "discovery", "text-files"),
				},
			},
			expectedCount: 3,
			prefix:        "",
		...
		},
		{
			...
			args: args{
				paths: []string{
					filepath.Join("testdata", "discovery", "text-files", "test.txt"),
				},
			},
			prefix:        "",
			jobId:         "test-id",
		...
		},
		{
			...
			args: args{
				paths: []string{
					sep + filepath.Join("testdata", "discovery", "text-files", "test.txt"),
				},
			},
			prefix:        "",
			jobId:         "test-id",
		...
		},
		{
			...
			args: args{
				paths: []string{filepath.Join("testdata", "discovery", "no-access", "no-access.txt")},
			},
			prefix:        "",
			jobId:         "test-id",
			expectedCount: 0,
