...
func main() {
	...
	httpAddress := flag.String("http-address", "127.0.0.1", "HTTP bind address for streamable-http transport")
	flag.Parse()

	if err := mcpserver.Run(*transport, *httpPort, *httpAddress); err != nil {
