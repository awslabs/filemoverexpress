...
func startUploadHandler(
	cm *ClientManager,
) func(ctx context.Context, req *mcp.CallToolRequest, input StartUploadInput) (*mcp.CallToolResult, StartUploadOutput, error) {
...
func startDownloadHandler(
	cm *ClientManager,
) func(ctx context.Context, req *mcp.CallToolRequest, input StartDownloadInput) (*mcp.CallToolResult, StartDownloadOutput, error) {
